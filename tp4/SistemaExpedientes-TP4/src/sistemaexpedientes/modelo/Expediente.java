...
public class Expediente {
    ...
    public String toString() {
        ...
        if (contribuyente != null) {
            if ("Jurídico".equalsIgnoreCase(contribuyente.getTipoContribuyente())) {
                nombreContribuyente = contribuyente.getRazonSocial();
            } else {
                nombreContribuyente = contribuyente.getApellido() + ", " + contribuyente.getNombre();
            }
        } else {
            nombreContribuyente = "Sin contribuyente";
        }

        return getNomenclatura() + " - " + nombreContribuyente;
    }
