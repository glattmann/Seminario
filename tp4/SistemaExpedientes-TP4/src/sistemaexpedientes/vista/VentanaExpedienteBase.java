...
import sistemaexpedientes.controlador.ControladorTipoTramite;
...
public abstract class VentanaExpedienteBase extends JFrame {
    ...
    protected ControladorExpediente controladorExpediente = new ControladorExpediente();
    protected List<Expediente> listaExpedientes = controladorExpediente.obtenerTodos();
    protected ControladorRubro controladorRubro = new ControladorRubro();
    protected ControladorTipoTramite controladorTipoTramite = new ControladorTipoTramite();
    


    // Campos del formulario
    protected JTextField txtNomenclatura, txtFechaHora, txtTipo;
    ...
    public VentanaExpedienteBase() {
        ...
        // Carga inicial de expedientes desde base
        this.listaExpedientes = controladorExpediente.obtenerTodos();
